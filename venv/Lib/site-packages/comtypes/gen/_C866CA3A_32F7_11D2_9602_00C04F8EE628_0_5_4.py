...
__all__ = [
    ...
    'SPVPRIORITY', 'ISpShortcut', 'DISPID_SABIMinNotification',
    'SAFT11kHz8BitStereo', 'SP_VISEME_0', 'DISPID_SRState',
    'SPFM_CREATE', 'eLEXTYPE_PRIVATE5', 'SVEBookmark',
    'DISPID_SRRecognizer', 'DISPID_SRGReset', 'DISPID_SRGCommit',
    'SDA_No_Trailing_Space', 'SPVPRI_ALERT',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRules_NewEnum',
    'SpeechVoiceEvents', 'SPEI_RESERVED3', 'SPEI_SR_AUDIO_LEVEL',
    'WAVEFORMATEX', 'SVP_8', 'SPINTERFERENCE_NONE', 'SPLEXICONTYPE',
    'SPAR_Medium', 'DISPID_SVResume', 'DISPID_SRSNumberOfActiveRules',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SGRId',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SFSOpen', 'IStream',
    'eWORDTYPE_DELETED', 'SPEI_START_INPUT_STREAM', 'DISPID_SVVoice',
    'SpeechRuleState', 'SpeechRecoContextState', 'ISpDataKey',
    'SPPS_LMA', 'DISPID_SpeechPhraseReplacements', 'ISpPhraseAlt',
    ...
    'DISPID_SPIGrammarId', 'SpeechCategoryRecoProfiles',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpRecognizer2',
    'DISPID_SVSpeakCompleteEvent', 'SPEI_ADAPTATION',
    'SPEI_SOUND_START', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPEActualConfidence', 'SpeechRecognizerState',
    'DISPID_SABufferInfo', 'DISPID_SpeechAudioFormat',
    'SpeechRunState', 'SPWF_SRENGINE', 'SREAudioLevel',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SAFType',
    'DISPID_SPIElements', 'DISPID_SLPType',
    'SpeechCategoryAppLexicons', 'DISPID_SOTCId', 'SAFT8kHz16BitMono',
    'SPCT_COMMAND', 'DISPID_SPIAudioSizeTime', 'SPRS_INACTIVE',
    'DISPID_SDKDeleteValue', 'SpSharedRecoContext',
    'SpeechInterference', 'DISPID_SLWLangId', 'SLOStatic', 'SWTAdded',
    'SPWAVEFORMATTYPE', 'DISPID_SpeechAudioStatus',
    'DISPID_SCSBaseStream', 'SPSSuppressWord', 'SECFIgnoreWidth',
    'DISPID_SPPEngineConfidence',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLWs_NewEnum',
    'SpAudioFormat', 'ISpRecognizer3', 'SPCS_ENABLED',
    'SPGS_DISABLED', 'SP_VISEME_7', 'DISPID_SPCIdToPhone',
    'SPPROPERTYINFO', 'ISpeechPhraseProperties',
    'DISPID_SLGetGenerationChange', 'SECHighConfidence',
    'SPVPRI_NORMAL', 'SPEI_MAX_TTS', 'DISPID_SRRSaveToMemory',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRGetPropertyString',
    'SSFMOpenForRead', 'ISpeechRecoResult', 'DISPID_SOTCDefault',
    'ISpeechLexiconPronunciations', 'SPWORDTYPE',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCEventInterests',
    'SVSFNLPMask', 'SWPUnknownWordUnpronounceable', 'SRCS_Disabled',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCState', 'SRERequestUI',
    'DISPID_SGRsCommit', 'SDTPronunciation', 'DISPID_SGRAttributes',
    'SRSEIsSpeaking', 'SPEI_RESERVED1', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPEsCount', 'SVSFParseSsml', 'DISPID_SRAudioInput',
    'SVP_19', 'DISPID_SRRAudio', 'ISpeechVoiceStatus',
    'SPPS_Noncontent', 'SAFT24kHz8BitMono', 'SPDKL_CurrentUser',
    'STSF_LocalAppData', 'SVP_7', 'SPFILEMODE', 'SpeechRecoEvents',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRRAudioFormat',
    'DISPID_SPRNumberOfElements', 'SPPS_Unknown', 'SPLO_STATIC',
    'DISPID_SLPSymbolic', 'ISpVoice', 'SPAS_RUN',
    'DISPID_SPIEnginePrivateData', 'DISPID_SWFEChannels', 'ISpPhrase',
    'DISPID_SVPause', 'SAFTCCITT_ALaw_44kHzStereo', 'SVEPrivate',
    'SPSERIALIZEDRESULT', 'SITooLoud', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_HYPOTHESIS', 'ISpeechAudio', 'STCInprocServer',
    'ISequentialStream', 'DISPID_SPEsItem', 'DISPID_SRIsUISupported',
    '_RemotableHandle', 'SITooFast', 'DISPID_SDKOpenKey',
    'SAFT24kHz16BitStereo', 'SP_VISEME_16', 'SASStop',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFT24kHz8BitStereo', 'SVSFDefault', 'DISPIDSPRG',
    'Speech_StreamPos_RealTime', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT12kHz8BitMono',
    'DISPID_SLPLangId', 'SpeechTokenIdUserLexicon', 'SRAONone',
    'SPSLMA', 'DISPID_SRRTStreamTime', 'SAFT44kHz16BitStereo',
    'DISPID_SRGDictationUnload', 'SREFalseRecognition',
    'DISPIDSPTSI_SelectionLength', 'ISpeechRecoContext',
    'SPGS_EXCLUSIVE', 'STCRemoteServer', 'SPFM_CREATE_ALWAYS',
    'ISpeechRecoResult2', 'SpeechDisplayAttributes',
    'DISPID_SOTDataKey', 'DISPID_SVIsUISupported', 'SPPHRASEPROPERTY',
    'SPPS_Noun', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPAUDIOSTATE', 'SPCONTEXTSTATE',
    'IInternetSecurityMgrSite', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLGetWords', 'DISPID_SpeechRecognizer',
    'DISPID_SRCRetainedAudio', 'DISPID_SRCEPhraseStart',
    'SpeechGrammarWordType', 'DISPID_SRCEAdaptation',
    'DISPID_SPAsCount', 'DISPID_SpeechPhraseReplacement',
    'SpObjectToken', 'SpMemoryStream', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPERetainedStreamOffset', 'SpVoice', 'SVEWordBoundary',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SOTsCount',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechLexiconPronunciation',
    'SECFEmulateResult', 'SPWT_DISPLAY', 'DISPID_SVSInputWordLength',
    'DISPID_SPARecoResult', 'SpeechVisemeFeature',
    'Speech_Max_Pron_Length', 'DISPID_SpeechWaveFormatEx',
    'SAFT22kHz8BitStereo', 'DISPID_SPPs_NewEnum', 'DISPID_SPIRule',
    'SP_VISEME_9', 'SPRECORESULTTIMES', 'DISPID_SPPChildren',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPPParent', 'DISPID_SPILanguageId', 'SASRun',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPRuleEngineConfidence',
    'SPGS_ENABLED', 'DISPID_SASState', 'SAFT48kHz8BitMono',
    'SAFT12kHz16BitMono', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechPhraseInfo', 'DISPID_SDKGetStringValue',
    'SPAO_NONE', 'SAFT16kHz16BitStereo', 'DISPID_SpeechVoiceEvent',
    'SpeechStreamFileMode', 'eLEXTYPE_APP',
    'DISPID_SWFESamplesPerSec', 'SpFileStream', 'SVSFPersistXML',
    'DISPID_SpeechLexicon', 'eLEXTYPE_RESERVED7', 'SVEAllEvents',
    'SASPause', 'SSTTTextBuffer', 'SINoSignal',
    'DISPID_SRRSetTextFeedback', 'STCLocalServer', 'DISPID_SVEWord',
    'DISPID_SGRsCommitAndSave', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTPropertyName', 'SDA_Consume_Leading_Spaces',
    'ISpRecoCategory', 'DISPID_SOTsItem', 'DISPID_SRGRecoContext',
    'SRERecoOtherContext', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_REQUEST_UI', 'LONG_PTR', 'DISPID_SOTCEnumerateTokens',
    'SDKLDefaultLocation', 'DISPID_SVWaitUntilDone',
    'SAFT12kHz8BitStereo', 'DISPID_SRSSupportedLanguages',
    'ISpeechVoice', 'SPEI_START_SR_STREAM',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPPConfidence',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechDataKey', 'SPEI_RESERVED2',
    'DISPIDSPTSI_ActiveOffset', 'SpeechRegistryLocalMachineRoot',
    'SVSFUnusedFlags', 'SpeechTokenShellFolder',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechCustomStream',
    'DISPID_SVESentenceBoundary', 'DISPID_SVEViseme',
    'DISPID_SRGetPropertyNumber', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVAudioOutputStream', 'SPRECOSTATE', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE10', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPRuleName', 'SVP_18', 'SPWF_INPUT', 'SVP_0',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRuleParent',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_MAX_SR',
    'SAFT48kHz8BitStereo', 'SGSExclusive', 'SRSInactiveWithPurge',
    'DISPID_SOTCGetDataKey', 'SGRSTTWord', 'DISPID_SGRsDynamic',
    'DISPID_SGRsCount', 'SPPARTOFSPEECH', 'DISPID_SRCEEndStream',
    'SPEI_MIN_SR', 'ISpeechMMSysAudio', 'DISPID_SRGCmdSetRuleState',
    'SPLO_DYNAMIC', 'SP_VISEME_20', 'SPRULE', 'DISPID_SAStatus',
    ...
    'DISPID_SpeechPhraseBuilder', 'SPPS_Modifier', 'SVP_17',
    'DISPID_SGRSTWeight', 'DISPID_SRCPause', 'SPEI_INTERFERENCE',
    'DISPID_SLPPartOfSpeech', 'SVF_None', 'DISPID_SGRSTText',
    'ISpStream', 'SpeechRetainedAudioOptions', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechRecoContext', 'DISPID_SDKGetBinaryValue',
    'SPVOICESTATUS', 'SREPrivate', 'SAFTADPCM_22kHzMono',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRStatus',
    'DISPID_SRRAlternates', 'SPPS_Function', 'SPPS_RESERVED2',
    'SPRST_INACTIVE_WITH_PURGE', 'SPWT_LEXICAL',
    'DISPID_SRCEStartStream', 'SPSHT_OTHER',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SOTCSetId', 'DISPID_SPISaveToMemory',
    'DISPID_SLWPronunciations', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPRST_ACTIVE_ALWAYS', 'ISpGrammarBuilder', 'SP_VISEME_3',
    'SVPNormal', 'DISPID_SGRSTNextState', 'SSTTWildcard',
    'DISPID_SRCAudioInInterferenceStatus', 'SRADynamic',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseReplacement',
    'DISPID_SRCEBookmark', 'DISPID_SASNonBlockingIO',
    'DISPID_SVEStreamEnd', 'SpeechTokenContext', 'SVSFVoiceMask',
    'DISPID_SpeechGrammarRules', 'DISPID_SPERetainedSizeBytes',
    '_SPAUDIOSTATE', 'SGDSActive', 'ISpeechTextSelectionInformation',
    'DISPID_SPEAudioSizeTime', 'SpeechPartOfSpeech',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPSModifier', 'SVSFParseSapi',
    'SPFM_NUM_MODES', 'DISPID_SPEPronunciation', 'ISpeechPhraseRules',
    'SPCT_SUB_DICTATION', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRGDictationSetState', 'SpNullPhoneConverter',
    'SRAExport', 'DISPID_SRRTimes', 'SVSFNLPSpeakPunc',
    'eLEXTYPE_PRIVATE18', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechBookmarkOptions', 'ISpeechDataKey', 'SSFMCreateForWrite',
    'STCInprocHandler', 'DISPID_SDKSetBinaryValue',
    'DISPID_SGRSAddSpecialTransition', 'SAFT44kHz8BitMono',
    'ISpObjectToken', 'SAFTGSM610_22kHzMono', 'SPBINARYGRAMMAR',
    'SpInProcRecoContext', 'DISPID_SMSGetData',
    'ISpeechPhraseProperty', 'DISPID_SRRTLength',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVSVisemeId', 'SREPropertyStringChange', 'SP_VISEME_14',
    'SREHypothesis', 'SpeechLoadOption', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRRDiscardResultInfo', 'SAFT12kHz16BitStereo',
    'ISpEventSink', 'SPEI_END_SR_STREAM', 'SP_VISEME_10',
    'DISPID_SVEStreamStart', 'SDTAlternates',
    'DISPID_SPRuleFirstElement', 'SPEI_PHONEME', 'SRSActiveAlways',
    'DISPID_SPRFirstElement', 'SVP_13', 'DISPID_SRCRequestedUIType',
    'SAFTText', 'DISPID_SMSAMMHandle', 'ISpStreamFormatConverter',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechMemoryStream',
    'SGSEnabled', 'SECLowConfidence', 'SPSHT_NotOverriden',
    'SpeechTokenKeyUI', 'SVP_9', 'DISPID_SLWType',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE7', 'SVF_Stressed',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE3',
    'DISPIDSPTSI_SelectionOffset', 'SPEVENTENUM',
    'SAFTCCITT_ALaw_11kHzMono', 'SVP_15', 'SGDSActiveWithAutoPause',
    'ISpeechGrammarRule', 'SpeechVisemeType', 'ISpSerializeState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechGrammarTagDictation', 'SDTProperty',
    'SpeechEmulationCompareFlags', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGetFormat', 'SGRSTTWildcard',
    'SpTextSelectionInformation', 'SPRECOGNIZERSTATUS',
    'DISPID_SBSRead', 'DISPID_SGRs_NewEnum',
    'DISPID_SDKSetStringValue', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT16kHz16BitMono',
    'ISpXMLRecoResult', 'DISPID_SLWsItem', 'DISPID_SLPs_NewEnum',
    'ISpResourceManager', 'SPSEMANTICFORMAT', 'SASClosed',
    'SpeechRegistryUserRoot', 'ISpeechGrammarRuleStateTransitions',
    'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_PRIVATE2',
    'SECFIgnoreKanaType', 'SpeechAudioFormatType',
    'eLEXTYPE_PRIVATE20', 'ISpeechPhraseAlternate',
    'SpeechLexiconType', 'SREPhraseStart', 'ISpeechPhraseInfoBuilder',
    'ISpNotifySink', 'SpeechCategoryAudioOut', 'SPLOADOPTIONS',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVSRunningState',
    'SpStream', 'DISPID_SVSpeak', 'SSSPTRelativeToStart',
    'SPSHT_Unknown', 'eLEXTYPE_RESERVED9', 'SpMMAudioOut',
    'SpeechUserTraining', 'eLEXTYPE_USER', 'SAFT24kHz16BitMono',
    'DISPID_SGRsFindRule', 'SpCustomStream', 'DISPID_SVSLastBookmark',
    'DISPID_SLWWord', 'SPEVENT', 'SAFTGSM610_44kHzMono',
    'ISpeechLexiconPronunciation', 'DISPID_SGRSTRule',
    'DISPID_SLGenerationId', 'SRAORetainAudio', 'SP_VISEME_5',
    'SP_VISEME_19', '__MIDL_IWinTypes_0009',
    'DISPID_SpeechRecoResult', 'SWPUnknownWordPronounceable',
    'SDKLCurrentUser', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRGetXMLErrorInfo', 'SPCATEGORYTYPE',
    'DISPID_SpeechFileStream', 'DISPID_SVAudioOutput',
    'SECFNoSpecialChars', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPELexicalForm', 'SPPS_RESERVED4', 'DISPID_SRCRecognizer',
    'DISPID_SPRs_NewEnum', 'SPRS_ACTIVE_USER_DELIMITED', 'tagSTATSTG',
    'SGDisplay', 'SPEI_SOUND_END', 'ISpeechRecoResultTimes', 'SVP_4',
    'Speech_StreamPos_Asap', 'ISpeechObjectTokens',
    'DISPID_SpeechPhraseProperty', 'SpCompressedLexicon',
    'SpeechRuleAttributes', 'SVP_21', 'DISPID_SOTDisplayUI',
    'SVEEndInputStream', 'DISPID_SRDisplayUI',
    'SpeechRecoProfileProperties', 'DISPID_SPPId',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVSLastResult',
    'ISpeechAudioBufferInfo', 'SGLexicalNoSpecialChars',
    'DISPID_SBSFormat', 'SpeechVoicePriority',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVEventInterests',
    'DISPID_SRRTTickCount', 'SPEI_RESERVED6',
    'SpeechCategoryRecognizers', 'DISPID_SPACommit', 'SRARoot',
    'ISpAudio', 'DISPID_SBSSeek', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRGIsPronounceable', 'DISPID_SADefaultFormat',
    'IEnumString', 'SPEI_MIN_TTS', 'DISPID_SVGetProfiles',
    'SPAUDIOSTATUS', 'SAFT22kHz16BitStereo', 'ISpeechLexicon',
    'SP_VISEME_4', 'DISPID_SpeechVoiceStatus', 'STSF_FlagCreate',
    'SPXRO_SML', 'SPBO_AHEAD', 'SPDKL_LocalMachine',
    'DISPID_SVSLastBookmarkId', 'SAFTNonStandardFormat', 'SITooSlow',
    'SpUnCompressedLexicon', 'SRAImport', 'ISpeechResourceLoader',
    'SpeechDictationTopicSpelling', 'DISPID_SOTRemove',
    'DISPID_SRGCmdLoadFromFile', 'SVEStartInputStream',
    'SREAllEvents', 'SpeechFormatType', 'SRCS_Enabled',
    'DISPID_SPRsCount', 'SAFT8kHz8BitMono', 'SECFIgnoreCase',
    'ISpEventSource', 'SPPS_Verb', 'ISpeechPhraseReplacements',
    'SPAO_RETAIN_AUDIO', 'SAFTNoAssignedFormat',
    'SpeechRecognitionType', 'SpMMAudioIn',
    'DISPID_SpeechCustomStream', 'DISPID_SPPsCount',
    'SPEI_SR_BOOKMARK', 'DISPID_SGRsItem', 'SPSFunction',
    'SPPHRASEELEMENT', 'SpeechDataKeyLocation',
    'DISPID_SRSetPropertyNumber', 'DISPID_SABIBufferSize',
    'DISPID_SGRAddResource', 'SSFMOpenReadWrite', 'SLTApp',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SGRSTType',
    'DISPID_SVGetAudioInputs', 'SAFT48kHz16BitStereo',
    'DISPID_SRCERecognition', 'DISPID_SRRPhraseInfo',
    'SVSFIsFilename', 'SPWORDPRONUNCIATION',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTId', 'SVSFParseMask',
    'SPCS_DISABLED', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_PRIVATE6', 'SWPKnownWordPronounceable',
    'SAFT11kHz16BitStereo', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_12', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVSInputSentencePosition', 'SPAR_Low',
    'SAFTADPCM_8kHzMono', 'SP_VISEME_8', 'SPAS_STOP',
    'SpeechCategoryAudioIn', 'ISpRecoResult', 'SPWORDPRONOUNCEABLE',
    'DISPID_SFSClose', 'SPVISEMES',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SDKEnumValues',
    'SVSFIsXML', 'SINone', 'SAFT11kHz8BitMono', 'DISPID_SASetState',
    'DISPID_SREmulateRecognition', 'ISpeechAudioFormat', 'SVP_2',
    'SPRST_ACTIVE', 'DISPID_SpeechLexiconWord',
    'SpStreamFormatConverter', 'SVEAudioLevel',
    'DISPID_SOTRemoveStorageFileName', 'SpResourceManager',
    'DISPID_SpeechGrammarRule', 'ISpRecoContext2',
    'DISPID_SRCEEnginePrivate', 'SPBO_TIME_UNITS',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVRate', 'SVP_20',
    'ISpLexicon', 'DISPID_SPCLangId', 'DISPID_SpeechAudioBufferInfo',
    'SAFTExtendedAudioFormat', 'DISPID_SRSetPropertyString',
    'DISPID_SRCVoice', 'DISPID_SRCEAudioLevel', 'SAFT22kHz8BitMono',
    'SAFTDefault', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIAudioStreamPosition', 'eLEXTYPE_PRIVATE17',
    'SRSInactive', 'SpWaveFormatEx', 'SPAUDIOOPTIONS', 'SVP_3',
    'SINoise', 'SPPS_SuppressWord', 'SAFT32kHz16BitMono',
    'eLEXTYPE_PRIVATE12', 'SVP_10', 'SpShortcut',
    'DISPID_SPRuleChildren', 'DISPID_SVEPhoneme', 'SRSEDone',
    'SPCT_SLEEP', 'DISPID_SPEAudioTimeOffset', 'STCAll',
    'DISPID_SRCEInterference', 'DISPID_SPIEngineId',
    'SpeechCategoryPhoneConverters', 'SPEI_RECO_STATE_CHANGE',
    'SpeechDiscardType', 'SPINTERFERENCE_TOOFAST', 'SRTEmulated',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPEEngineConfidence',
    'SRATopLevel', 'SpeechAudioProperties',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SWFEAvgBytesPerSec',
    'eLEXTYPE_PRIVATE19', 'SpeechCategoryVoices',
    'SpeechAudioFormatGUIDText', 'SAFT11kHz16BitMono',
    'ISpeechXMLRecoResult', 'SPXMLRESULTOPTIONS',
    'DISPID_SRSClsidEngine', 'DISPID_SRSCurrentStreamNumber',
    'ISpNotifyTranslator', 'SPSHT_EMAIL', 'IEnumSpObjectTokens',
    'SAFT16kHz8BitStereo', 'DISPID_SABufferNotifySize', 'SRTStandard',
    'SPRECOCONTEXTSTATUS', 'SPAR_Unknown', 'DISPID_SPPName',
    'DISPID_SpeechRecoResult2', 'SVP_16', 'DISPID_SDKDeleteKey',
    'ISpStreamFormat', 'eLEXTYPE_USER_SHORTCUT', 'SAFT8kHz8BitStereo',
    'DISPID_SLWsCount', 'DISPID_SPPsItem',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechPhraseElements',
    'ISpObjectTokenCategory', 'SPRS_ACTIVE', 'SWTDeleted',
    'eLEXTYPE_RESERVED10', 'DISPID_SGRSAddRuleTransition',
    'SAFT44kHz16BitMono', 'SREBookmark', 'SVP_5', 'SPEI_VISEME',
    'SVP_14', 'SpeechStreamSeekPositionType',
    'SpeechGrammarTagWildcard', 'DISPID_SWFEBlockAlign',
    'ISpeechObjectTokenCategory', 'ISpPhoneConverter',
    'DISPID_SVVolume', 'SAFTGSM610_8kHzMono', 'DISPID_SRIsShared',
    'SRTExtendableParse', 'DISPID_SRRRecoContext',
    'DISPID_SRCEPropertyStringChange', 'SPSTREAMFORMATTYPE',
    'DISPID_SPRuleId', 'DISPID_SpeechMMSysAudio', 'SPWORD',
    'SRSActive', 'DISPID_SAFSetWaveFormatEx', 'DISPID_SVEBookmark',
    'DISPID_SPIReplacements', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPRulesItem', 'SPTEXTSELECTIONINFO', 'SP_VISEME_21',
    'SPEI_TTS_PRIVATE', 'SPPHRASEREPLACEMENT',
    'SPEI_SR_RETAINEDAUDIO', 'SP_VISEME_18', 'SP_VISEME_15',
    'SpObjectTokenCategory', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPAPhraseInfo', 'SRADefaultToActive',
    'DISPID_SpeechPhraseRules', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPPValue', 'DISPID_SLGetPronunciations',
    'DISPID_SRGDictationLoad', 'SVESentenceBoundary',
    'DISPID_SpeechLexiconWords', 'ISpeechRecoGrammar',
    'SpeechTokenKeyFiles', 'STSF_AppData', 'SpeechWordType',
    'ISpeechPhraseAlternates', 'DISPID_SMSALineId',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRRSpeakAudio', 'SGPronounciation',
    'DISPID_SGRInitialState', 'DISPID_SPIProperties', 'ISpProperties',
    'SFTSREngine', 'SPINTERFERENCE', 'DISPID_SGRSTsItem',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SOTCategory',
    'eLEXTYPE_RESERVED6', 'DISPID_SPRuleConfidence', 'SP_VISEME_1',
    'DISPID_SRCCreateResultFromMemory',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SOTGetDescription', 'DISPID_SpeechVoice',
    'SpeechAudioState', 'SSFMCreate', 'DISPID_SVDisplayUI',
    'SPSEMANTICERRORINFO', 'SAFTADPCM_11kHzMono',
    'ISpeechGrammarRules', 'SpInprocRecognizer', 'DISPID_SMSSetData',
    'SPBO_PAUSE', 'SPDKL_CurrentConfig', 'SPSHORTCUTPAIR',
    'DISPID_SPEDisplayText', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SDKLCurrentConfig', 'DISPID_SVSPhonemeId',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechGrammarState',
    'DISPID_SpeechObjectTokens', 'SAFT32kHz8BitMono',
    'ISpRecoGrammar2', 'DISPID_SVStatus',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechFileStream',
    'ISpeechLexiconWord', 'SVF_Emphasis', 'SSSPTRelativeToEnd',
    'SpeechTokenKeyAttributes', 'Speech_Default_Weight',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPIStartTime',
    'DISPID_SpeechObjectToken', 'DISPIDSPTSI', 'SGRSTTRule',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechAudio',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPWT_PRONUNCIATION',
    'ISpeechBaseStream', 'SPPHRASE', 'SPGRAMMARSTATE',
    'SPSHORTCUTTYPE', 'SPFM_OPEN_READWRITE', 'ISpMMSysAudio',
    'DISPID_SVAlertBoundary', 'DISPID_SPRulesCount', 'SDTRule',
    'SPAUDIOBUFFERINFO', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPDATAKEYLOCATION', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SDTAudio', 'ISpeechPhraseInfo', 'DISPID_SVEVoiceChange',
    'SPRST_NUM_STATES', 'SpeechAddRemoveWord', 'SREAdaptation',
    'DISPID_SDKGetlongValue', 'DISPID_SGRSTPropertyId',
    'SAFTCCITT_ALaw_8kHzMono', 'SPSUnknown', 'SPINTERFERENCE_TOOLOUD',
    'SPSInterjection', 'SPAR_High', 'SAFT8kHz16BitStereo',
    'DISPID_SBSWrite', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechAudioFormatGUIDWave', 'SPGRAMMARWORDTYPE',
    'DISPID_SOTGetAttribute', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRRGetXMLResult', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVSpeakStream', 'DISPID_SRGCmdLoadFromMemory',
    'eLEXTYPE_VENDORLEXICON', 'SAFT16kHz8BitMono',
    '_ISpeechVoiceEvents', 'DISPID_SGRName', 'ISpeechPhoneConverter',
    'SGRSTTEpsilon', 'UINT_PTR', 'ISpeechRecognizer',
    'eLEXTYPE_MORPHOLOGY', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpPhoneticAlphabetConverter', 'SP_VISEME_17',
    'DISPID_SVEEnginePrivate', 'SVP_12', 'SpeechEngineConfidence',
    'DISPID_SGRSRule', 'DISPID_SRRTOffsetFromStart', 'SP_VISEME_11',
    'DISPID_SRAudioInputStream', 'SDKLLocalMachine',
    'eLEXTYPE_PRIVATE4', 'ISpeechGrammarRuleState', 'DISPID_SAVolume',
    'SPINTERFERENCE_NOISE', 'SpMMAudioEnum', 'STSF_CommonAppData',
    'ISpeechRecoResultDispatch', 'SVEViseme', 'SREStreamStart',
    'SGDSInactive', 'SDA_One_Trailing_Space', 'SAFT48kHz16BitMono',
    'SPVPRI_OVER', 'eWORDTYPE_ADDED', 'DISPID_SRCBookmark',
    'DISPID_SRCreateRecoContext', 'DISPID_SGRAddState', 'SPBO_NONE',
    'SREStreamEnd', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVPriority',
    'ISpRecoContext', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRsAdd',
    'DISPID_SWFEExtraData', 'SP_VISEME_6',
    'DISPID_SRCCmdMaxAlternates', 'SpPhraseInfoBuilder',
    'SRAInterpreter', 'SPSERIALIZEDPHRASE', 'SVSFIsNotXML',
    'DISPID_SRGId', 'SPRULESTATE', 'SVP_11',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCERequestUI',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPRsItem',
    'SPEI_PHRASE_START', 'SPSMF_SAPI_PROPERTIES', 'SPSVerb',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SAFGuid', 'SPEI_SR_PRIVATE',
    'SVPOver', 'DISPID_SOTs_NewEnum', 'SpeechMicTraining',
    'SITooQuiet', 'ISpeechPhraseElement', 'DISPID_SRCCreateGrammar',
    'ISpeechWaveFormatEx', 'DISPID_SPRuleNumberOfElements',
    'SpeechWordPronounceable', 'SFTInput', 'DISPID_SPRText',
    'SpeechPropertyAdaptationOn', 'SpLexicon',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCResume', 'SPAS_CLOSED', 'SPFM_OPEN_READONLY',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SDKCreateKey',
    'IInternetSecurityManager', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_1',
    'DISPID_SpeechPhraseProperties', 'SVEPhoneme',
    'ISpeechPhraseRule', 'DISPID_SRGRules', 'SpeechEngineProperties',
    'DISPID_SPAStartElementInResult', 'DISPID_SRGCmdSetRuleIdState',
    'SPCT_DICTATION', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SOTSetId', 'SVP_6',
    'SP_VISEME_2', 'DISPID_SPEs_NewEnum', 'ISpeechObjectToken',
    'SpeechGrammarRuleStateTransitionType', 'SPSHORTCUTPAIRLIST',
    'SECNormalConfidence', 'SAFTGSM610_11kHzMono', 'SDTLexicalForm',
    'DISPID_SMSADeviceId', 'tagSPPROPERTYINFO', 'SPSMF_UPS',
    'DISPID_SRCSetAdaptationData', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLPPhoneIds', 'ISpeechRecognizerStatus',
    'SpeechAllElements', 'SPEI_TTS_AUDIO_LEVEL',
    'tagSPTEXTSELECTIONINFO', 'SDTReplacement',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SGRClear', 'ISpPhoneticAlphabetConverter',
    'SPPS_Interjection', 'DISPID_SRCESoundEnd', 'DISPID_SVGetVoices',
    'SRTAutopause', 'ISpRecoGrammar', 'SREPropertyNumChange',
    'SPXRO_Alternates_SML', 'DISPID_SVSInputWordPosition',
    'DISPID_SRGetRecognizers', 'SPPS_RESERVED3', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_RESERVED4', 'SpeechPropertyResourceUsage',
    'Speech_Max_Word_Length', 'DISPID_SWFEFormatTag', 'SGLexical',
    'SPRST_INACTIVE', 'SGRSTTDictation', 'DISPID_SABIEventBias',
    'SPPS_NotOverriden', 'ISpeechAudioStatus',
    'SpeechPropertyLowConfidenceThreshold', 'SPBOOKMARKOPTIONS',
    'SBOPause', 'DISPID_SpeechPhraseRule', 'SPEI_UNDEFINED',
    'SVSFParseAutodetect', 'DISPID_SRGSetTextSelection', 'SBONone',
    'SAFTADPCM_8kHzStereo', 'SPEI_END_INPUT_STREAM',
    'DISPID_SLPsItem', 'DISPID_SLRemovePronunciation', 'SLTUser',
    'SECFDefault', 'SPEVENTSOURCEINFO', 'SpSharedRecognizer',
    'SREInterference', 'SREStateChange', 'SRTSMLTimeout',
    'SLODynamic', 'DISPID_SpeechPhraseElement', 'SDTDisplayText',
    'SSTTDictation', 'DISPID_SPPFirstElement', 'SpNotifyTranslator',
    'DISPID_SPPBRestorePhraseFromMemory', 'SRERecognition',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SOTCreateInstance', 'DISPID_SPAsItem', 'SVEVoiceChange',
    'DISPID_SOTIsUISupported', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SAEventHandle', 'SP_VISEME_13', 'SPPHRASERULE',
    'SPEI_RESERVED5', 'SRTReSent', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRCEHypothesis', 'ISpNotifySource', 'SPSNoun',
    'SpeechAudioVolume', 'DISPID_SRGState',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_RECOGNITION',
    'ISpRecognizer', 'SpeechVoiceSpeakFlags', 'DISPID_SRProfile',
    'DISPID_SGRSTransitions', 'SRESoundEnd',
    'SpeechSpecialTransitionType', 'ISpeechLexiconWords',
    'DISPID_SRSAudioStatus', 'SpeechTokenValueCLSID', 'DISPID_SVSkip',
    'SVSFlagsAsync', 'DISPID_SPCPhoneToId', 'DISPID_SpeechBaseStream',
    'SVPAlert', 'SPADAPTATIONRELEVANCE', 'SAFT32kHz16BitStereo',
    'DISPID_SPIGetText', 'ISpeechMemoryStream', 'DISPID_SGRSTsCount',
    '_ISpeechRecoContextEvents', 'ISpeechPhraseElements',
    'DISPID_SVEAudioLevel', 'SPSNotOverriden', 'SRESoundStart',
    'SAFT22kHz16BitMono', 'DISPID_SRCEPropertyNumberChange',
    'SPPS_RESERVED1'
]

_check_version('1.1.14', 1764709776.194831)
